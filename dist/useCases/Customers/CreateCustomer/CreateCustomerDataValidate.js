...
class CreateCustomerDataValidate {
    execute(data) {
        ...
        (0, notIncludesTheKeys_1.notIncludesTheKeys)(availableFields, customer);
...
exports.CreateCustomerDataValidate = CreateCustomerDataValidate;
