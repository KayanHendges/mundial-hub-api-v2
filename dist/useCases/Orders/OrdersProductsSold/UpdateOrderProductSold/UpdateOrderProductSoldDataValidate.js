...
exports.UpdateOrderProductSoldDataValidate = void 0;
const notIncludesTheKeys_1 = require("../../../../services/dataValidate/notIncludesTheKeys");
class UpdateOrderProductSoldDataValidate {
    execute(data) {
        const id = data.id;
        if (typeof id != 'number') {
...
exports.UpdateOrderProductSoldDataValidate = UpdateOrderProductSoldDataValidate;
